...
export default function EditionsAdminPage() {
  ...
  async function deleteEdition(ed) {
    if (!confirm(`"${ed.name}" (${ed.pullout}) delete karna hai? Iska saara entry data bhi delete ho jayega.`)) return;
  ...
  function handleFileSelect(e) {
    ...
    Papa.parse(file, {
      ...
      complete: (results) => {
        ...
        if (rows.length === 0) {
          setImportErr('CSV me valid rows nahi mile. Header line "State,Branch,Edition,Pullout,Schedule time" honi chahiye.');
          return;
        }
        setCsvRows(rows);
      },
      ...
      <div className="container" style={{ maxWidth: 1000 }}>
        ...
        <div className="card">
          ...
          <p style={{ fontSize: 13, color: '#666' }}>
            ...
            "Schedule time" me poori date-time (2026-06-30 23:00:00) ho ya sirf time (23:00) - dono chalega,
            system khud sirf time nikal lega (yeh daily fix time ban jayega).
