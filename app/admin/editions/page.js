...
export default function EditionsAdminPage() {
  ...
  async function addEdition(e) {
    ...
    if (!form.schedule_page_time) { setErr('Please select a schedule time'); return; }
      ...
      <div className="container" style={{ maxWidth: 1000 }}>
        ...
        <div className="card">
          ...
          <form onSubmit={addEdition}>
            ...
            <TimeSelect value={form.schedule_page_time} onChange={v => setForm({ ...form, schedule_page_time: v })} />
              ...
              <tbody>
                {editions.map(ed => (
                  <tr key={ed.id}>
                    ...
                    <td>
                      <TimeSelect
                        value={ed.schedule_page_time?.slice(0,5)}
                        onChange={(v) => v && v !== ed.schedule_page_time?.slice(0,5) && updateField(ed, 'schedule_page_time', v)}
                      />
                    </td>
                    <td>
