    ...
    <>
      ...
      <div className="container" style={{ maxWidth: 900 }}>
        ...
        <div className="card">
          ...
          {loading ? <p>Loading...</p> : topDelay.length === 0 ? <p>Is date ke liye koi delay entry nahi hai.</p> : (
            <ResponsiveContainer width="100%" height={320}>
              <BarChart data={topDelay} layout="vertical" margin={{ left: 120 }}>
                ...
                <Tooltip />
                <Bar dataKey="delay" fill="#c8102e" radius={[0, 6, 6, 0]} />
              </BarChart>
            </ResponsiveContainer>
          )}
        </div>
        ...
        <div className="card">
          ...
          {loading ? <p>Loading...</p> : topEarly.length === 0 ? <p>Is date ke liye koi early entry nahi hai.</p> : (
            <ResponsiveContainer width="100%" height={320}>
              <BarChart data={topEarly} layout="vertical" margin={{ left: 120 }}>
                ...
                <YAxis type="category" dataKey="name" width={150} tick={{ fontSize: 12 }} />
                <Tooltip />
                <Bar dataKey="delay" fill="#1a7d3a" radius={[0, 6, 6, 0]} />
              </BarChart>
            </ResponsiveContainer>
          )}
        </div>
